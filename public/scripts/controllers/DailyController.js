angular.module("daily", [])
    .controller("DailyController", ["$scope", "$http", "$mdDialog", "$mdToast", "$filter", "$timeout", function ($scope, $http, $mdDialog, $mdToast, $filter, $timeout) {
        ...
        $scope.startCash = function () {
           return $scope.startSum() - $scope.daily.values.start.checks;
        };
        ...
        $scope.endCash = function () {
           return $scope.endSum() - $scope.daily.values.end.checks;
        };
        ...
        $scope.submit = function () {
            var data = {};
            data.start_cash = $scope.startCash();
            data.end_cash = $scope.endCash();
